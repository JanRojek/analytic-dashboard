...
namespace AnalyticDashboard.Infrastructure.Migrations
{
    ...
    [Migration("20260825185117_AddProjectCheckConstraints")]
    partial class AddProjectCheckConstraints
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("projects", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_projects_Name_NotBlank", "btrim(\"Name\"::text) <> ''");

                            t.HasCheckConstraint("CK_projects_Name_Trimmed", "\"Name\"::text = btrim(\"Name\"::text)");
