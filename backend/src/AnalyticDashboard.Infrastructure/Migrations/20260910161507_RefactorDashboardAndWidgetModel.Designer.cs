...
namespace AnalyticDashboard.Infrastructure.Migrations
{
    ...
    [Migration("20260910161507_RefactorDashboardAndWidgetModel")]
    partial class RefactorDashboardAndWidgetModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnalyticDashboard.Domain.Entities.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AnalyticDashboard.Domain.Entities.Widget", b =>
                {
                    ...
                    b.Property<string>("MeasureColumn")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("AnalyticDashboard.Domain.Entities.Widget", b =>
                {
                    b.HasOne("AnalyticDashboard.Domain.Entities.Dashboard", null)
                        .WithMany()
